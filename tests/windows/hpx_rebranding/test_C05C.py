...
class Test_C05C(object):
    ...
    def test_01_verify_profile_and_feedback_flow_C05C(self):
        ...
        text_value = self.feedback.get_tell_your_experience_text_value()
        assert text_value, "tell your experience text value not retrieved"
